...
export default function Terms() {
  useSEO({
    ...
    description: "Terms of Service for LeakQoara Group of Companies. Read our agreements governing use of our website, services, and corporate divisions.",
  });
  ...
  const sections = [
    {
      ...
      content: "By accessing, browsing, or using the corporate website, services, and platforms provided by LeakQoara Group of Companies (collectively referred to as the \"Services\"), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service (the \"Terms\") and all applicable global laws and regulations. If you do not agree with these Terms, you must immediately cease all use of our Services."
    },
    {
      id: "about",
      title: "2. About LeakQoara",
      content: "LeakQoara Group of Companies operates as a multinational conglomerate. Our operations span several specialized business divisions, including LePort (Logistics, Trade, & Supply Chain Solutions), LeTech (Cybersecurity & Advanced IT Solutions), specialized Cybersecurity Services, and various Research & Innovation Initiatives. These Terms apply generally to all interactions with our corporate presence, while specific enterprise service agreements may supplement these Terms for corporate clients."
    },
    {
      id: "eligibility",
    ...
    },
    {
      ...
      content: "You agree to use our Services only for lawful purposes. You are strictly prohibited from: (a) violating any local, national, or international laws; (b) attempting to breach, probe, or compromise our cybersecurity infrastructure, including the systems of our LeTech division; (c) introducing malicious software, viruses, or code designed to disrupt our networks; (d) engaging in unauthorized data collection, scraping, or harvesting; and (e) using our logistics or trade facilitation resources for illicit commerce."
    },
    {
      id: "ip-rights",
      title: "5. Intellectual Property Rights",
      content: "All content, proprietary marks, source code, designs, algorithms, trade secrets, logos (including the LeakQoara emblem), and assets displayed on our platforms are the exclusive property of LeakQoara Group of Companies or its licensors and are protected under international copyright, trademark, and patent laws. No license or right is granted to you to copy, modify, distribute, or reverse-engineer any intellectual property without explicit, written corporate authorization."
    },
    {
      id: "user-submissions",
      title: "6. User Submissions",
      content: "If you submit inquiries, feedback, or project proposals through our secure portals, you grant LeakQoara a non-exclusive, worldwide, royalty-free, perpetual license to use, review, and analyze such submissions for corporate evaluation and service improvements. All personal data included in submissions is strictly governed by our Privacy Policy."
    },
    {
      id: "availability",
      title: "7. Service Availability",
      content: "While we strive to ensure uninterrupted availability of our digital portals, trade networks, and cybersecurity systems, LeakQoara does not guarantee that access will be continuous, secure, or error-free. We reserve the right to temporarily suspend, modify, or restrict access to any part of our Services for maintenance, upgrades, or security protocols without prior liability."
    },
    {
      id: "third-party",
    ...
    },
    {
      ...
      content: "OUR SERVICES ARE PROVIDED ON AN \"AS IS\" AND \"AS AVAILABLE\" BASIS. LEAKQOARA GROUP OF COMPANIES DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE RESULTS OBTAINED FROM CyberSECURITY TOOLS OR LOGISTICS DATA WILL BE COMPLETELY ACCURATE OR ERROR-FREE."
    },
    {
      id: "limitation",
      title: "10. Limitation of Liability",
      content: "TO THE MAXIMUM EXTENT PERMITTED BY LAW, LEAKQOARA GROUP OF COMPANIES, ITS DIVISIONS (INCLUDING LETECH AND LEPORT), DIRECTORS, AND EMPLOYEES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR USE, INCURRED BY YOU OR ANY THIRD PARTY, ARISING OUT OF OR IN CONNECTION WITH YOUR ACCESS TO OR USE OF OUR SERVICES."
    },
    {
      id: "indemnification",
      title: "11. Indemnification",
      content: "You agree to indemnify, defend, and hold harmless LeakQoara Group of Companies, its subsidiaries, divisions, affiliates, officers, and agents from and against any and all claims, liabilities, damages, losses, or expenses (including reasonable legal fees) arising out of your violation of these Terms, misuse of our Services, or infringement of any intellectual property rights."
    },
    {
      id: "privacy-ref",
      title: "12. Privacy Reference",
      content: "Your privacy is paramount to LeakQoara. Our collection, processing, and protection of your personal information, including cookies and contact data, are defined in detail within our Privacy Policy, which is incorporated by reference into these Terms."
    },
    {
      id: "changes",
